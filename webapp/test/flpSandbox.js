		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#idodata1project50000-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idodata1project50000-display": {
								"semanticObject": "idodata1project50000",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idodata1.project50000",
									"url": sap.ui.require.toUrl("idodata1/project50000")
								}
							}
						}
					}
